                            ...
                            <div class="col-12 p-md-5 p-sm-4 p-3">
                                <form action="{{ route('update') }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="card-body">
                                                            <span onclick="remove_section(this)"
                                                                ...
                                                                style="top: 10px; right: 15px; cursor: pointer;"><i
                                                                    class="fa fa-close"></i></span>
                                                            <div class="form-outline mb-4">
                                                                <label class="form-label fw-bold text-secondary">Nombre del Trabajo</label>
                                                            ...
                                                            <div class="row mb-4">
                                                                ...
                                                                <div class="col-sm-6 col-12">
                                                                    <div class="form-outline">
                                                                        <label
                                                                            class="form-label fw-bold text-secondary">Finalizacion</label>
                                                            ...
                                                            <div class="form-outline mb-4">
                                                                <label class="form-label fw-bold text-secondary">Descripcion del trabajo</label>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-4 text-end">
                                                    <button class="btn btn-primary" id="add_project">Agregar proyecto </button>
                                                </div>
                                            </div>
                                                ...
                                                @foreach ($information['project_info'] as $project_info)
                                                    <div class="card mb-4">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-outline mb-4">
                                                                <label
                                                                    class="form-label fw-bold text-secondary">Titulo del proyecto</label>
                                                            ...
                                                            <div class="form-outline mb-4">
                                                                <label
                                                                    class="form-label fw-bold text-secondary">Descripcion  </label>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-4 text-end">
                                                    <button class="btn btn-primary" id="add_skill">Agregar habilidad </button>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-10">
                                                                    <div class="form-outline">
                                                                        <label
                                                                            class="form-label fw-bold text-secondary">Agregar habilidad </label>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-4 text-end">
                                                    <button class="btn btn-primary" id="add_language">Agregar idioma </button>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-10">
                                                                    <div class="form-outline">
                                                                        <label
                                                                            class="form-label fw-bold text-secondary">Agregar idioma </label>
                                                                        <select class="form-control" id="language"
                                                                            name="language[]">
                                                                            <option value="">Agregar idioma 
                                                                            </option>
                                                                            <option value="af"
                                                                    ...
                                                                    <div class="form-outline">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <select id="language_level"
                                                                                ...
                                                                                class="form-control"
                                                                                aria-describedby="percentage">
                                                                                <option value="">Seleccionar nivel 
                                                                                </option>
                                                                                <option value="Native"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-4 text-end">
                                                    <button class="btn btn-primary" id="add_interest">Agregar
                                                        intereses</button>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="card-body">
                                                            <span onclick="remove_section(this)"
                                                                ...
                                                                style="top: 10px; right: 15px; cursor: pointer;"><i
                                                                    class="fa fa-close"></i></span>
                                                            <div class="form-outline">
                                                                <label class="form-label fw-bold text-secondary">Agregar 
                                                                    Intereses</label>
                                    ...
                                    <div class="form-check d-flex justify-content-center mb-4">
                                        ...
                                        <label for="verify" class="form-check-label text-dark"> ¿Estas seguro de guardar los cambios?
                                        </label>
                                    </div>

                                    <!-- Submit button -->
                                    <button type="submit" id="submitbtn" class="btn btn-lg btn-success w-100">Guardar cambios </button>
                                </form>
                            </div>
                        </div>
                    </div>
