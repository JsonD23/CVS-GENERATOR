                                ...
                                <div class="sidebar-wrapper col-4">
                                    ...
                                    @if (!empty($information['education_info']))
                                        <div class="education-container container-block">
                                            <h2 class="container-block-title">Educacion </h2>
...
function printPDF() {
    ...
    html2canvas(element, {
        onrendered: function (canvas) {
            ...
            var doc = new jsPDF('p', 'mm', 'letter'); // 'letter' for 8.5 x 11 inches
            var imgWidth = 215.9; // ancho de la imagen en mm (8.5 inches)
            var pageHeight = 279.4; // altura de la página en mm (11 inches)
