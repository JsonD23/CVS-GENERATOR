...
class Userprofile extends Controller
{
    ...
    public function viewdos($id)
    {
        ...
        return view('viewdos', ['information' => $info]);
    }
    public function viewset($id)
    {
        ...
        return view('viewset', ['information' => $info]);
    }
    
    public function nuevaCreacion()
    {
        return view('nuevaCreacion');
    }

    public function storeNuevaCreacion(Request $request)
    {
        ...
        $contact_info = new ContactInformation();
        $contact_info->user_id = $personal_info->id;
        $contact_info->email = $request->email;
        $contact_info->phone_number = $request->phone_number;
        $contact_info->website = $request->website;
        $contact_info->linkedin_link = $request->linkedin_link;
        ...
        return redirect()->route('index')->withSuccess("Usuario creado exitosamente");
